...
public class ClientCouponMainActivity extends AppCompatActivity
...
//////로그인 정보 받아오기
        ...
        Toast.makeText(ClientCouponMainActivity.this, loginData.getEmail() + loginData.getName() + loginData.getPhotoUrl(), Toast.LENGTH_SHORT).show();
...
//////////////////////////////dialog
        ...
        allListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                new AlertDialog.Builder(ClientCouponMainActivity.this)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Client_Map) {
            ...
            Intent intent = new Intent(ClientCouponMainActivity.this, MapActivity.class);
            ...
            getWindow().setExitTransition(new Explode());
            Intent intent = new Intent(ClientCouponMainActivity.this, Used_list.class);
            ...
            getWindow().setExitTransition(new Explode());
            Intent intent = new Intent(ClientCouponMainActivity.this, ProximityActivity.class);
            intent.putExtra("loginData", loginData);
            //   startActivity(intent);
            startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(this).toBundle());
