...
public class UserCouponMainActivity extends AppCompatActivity
...
//////로그인 정보 받아오기
        ...
        Toast.makeText(UserCouponMainActivity.this, loginData.getEmail() + loginData.getName() + loginData.getPhotoUrl(), Toast.LENGTH_SHORT).show();
...
//////////////////////////////dialog
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                new AlertDialog.Builder(UserCouponMainActivity.this)
                        ...
                        .setPositiveButton("등록", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                try {//                                 id                              pl                              name        con                                     pho
                                    ...
                                    result = new CouponTask().execute(loginData.getEmail(), "", editPlace.getText().toString(), "", loginData.getName(),
                                            editContents.getText().toString(), "", loginData.getPhotoUrl(), "Cadd").get();
                                    if (result.equals("false")) {
                                        ...
                                        // result = new Sin_InLoginTask().execute(loginData.getEmail(), "", "C_select").get();
                                        adapter2.buildArrayList(result);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String s) {
                try {
                    ...
                    String result = new CouponTask().execute(loginData.getEmail(), "", searchView.getQuery().toString(), "", "", "", "", "", "user_search").get();
                    adapter2.buildArrayList(result);
                    adapter2.notifyDataSetChanged();
                } catch (Exception e) {
                }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.User_Map) {
            ...
            Intent intent = new Intent(UserCouponMainActivity.this, MapActivity.class);
            intent.putExtra("loginData", loginData);
            startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(this).toBundle());
            //   startActivity(intent);
        } else if (id == R.id.User_Search) {
            getWindow().setExitTransition(new Explode());
            Intent intent = new Intent(UserCouponMainActivity.this, Search.class);
            startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(this).toBundle());
            //   startActivity(intent);

        } else if (id == R.id.User_Chatting) {
            getWindow().setExitTransition(new Explode());
            Intent intent = new Intent(UserCouponMainActivity.this, ChatActivity.class);
            startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(this).toBundle());
            //   startActivity(intent);
        } else if (id == R.id.User_Client) {
            getWindow().setExitTransition(new Explode());
            Intent intent = new Intent(UserCouponMainActivity.this, Client_modeActivity.class);
            intent.putExtra("loginData", loginData);
            startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(this).toBundle());
            //   startActivity(intent);
        } else if (id == R.id.User_Share2) {
